...
public class Instruction {
    ...
    public Instruction(OpCode opCode) {
        this.opCode = opCode;
    } // Istruzioni senza operando
    public Instruction(OpCode opCode, int operand) { // Istruzioni con operando
        this.opCode = opCode;
        this.operand = operand;
    }

    // Restituisce l'istruzione nel formato adeguato per l'assembler Jasmin
